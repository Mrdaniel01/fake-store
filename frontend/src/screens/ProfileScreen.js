  ...
  return <div className='profile'>
    ...
    <form onSubmit={submitHandler} >
      <ul className="form-container">
        ...
        <li>
          <button  type="submit" className="button primary full-width">Update</button>
        </li>
        <li>
          <button onClick={handleLogout} type="button" className="button secondary full-width">Log out</button>
        </li>
